...
public class Calculadora {
     ...
     *
     * @param a primeiro operando
     * @param b segundo operando a ser subtraído
     ...
     *
     * <p>Caso o divisor seja zero, uma exceção é lançada para evitar
     * uma operação inválida.</p>
     *
     * @param a numerador (valor a ser dividido)
     * @param b denominador (valor pelo qual {@code a} será dividido)
